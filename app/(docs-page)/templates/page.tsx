    ...
    <>
      <div className='pt-20 pb-5'>
        ...
        <p className='md:text-lg text-sm text-muted-foreground lg:w-[80%]'>
          Beautifully designed templates that you can copy and paste into your apps. Accessible. Customizable. Responsive.
        </p>

        <div className="mt-44 text-center">
          <h1 className="text-2xl font-semibold tracking-tight text-center"> Templates are under construction 🚧👷‍ </h1>
